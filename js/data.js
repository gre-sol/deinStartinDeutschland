...
const JOURNEY_PHASES = [
  {
    ...
    colorVar: 'ankommen',
    items: [
      { title: 'Unterkunft', slug: 'unterkunft', status: 'internal-page' },
      { title: 'SIM-Karte & Internet', slug: 'sim-karte-internet', status: 'multiple-providers' },
      { title: 'Erste Orientierung', slug: 'erste-orientierung', status: 'internal-page' },
      { title: 'Krankenversicherung', slug: 'krankenversicherung-ankommen', status: 'internal-page' },
      { title: 'Wichtige Dokumente', slug: 'wichtige-dokumente-ankommen', status: 'internal-page' },
      { title: 'Notrufnummern & Erste Hilfe', slug: 'notrufnummern', status: 'internal-page' },
    ],
  },
  {
    id: 'wohnen',
    ...
    colorVar: 'wohnen',
    items: [
      { title: 'Wohnung finden', slug: 'wohnung-finden', status: 'internal-page' },
      { title: 'Mietvertrag verstehen', slug: 'mietvertrag-verstehen', status: 'internal-page' },
      { title: 'Wohnungsgeberbestätigung', slug: 'wohnungsgeberbestaetigung', status: 'internal-page' },
      { title: 'Anmeldung beim Bürgeramt', slug: 'anmeldung-buergeramt', status: 'internal-page' },
      { title: 'Meldebescheinigung', slug: 'meldebescheinigung', status: 'internal-page' },
      ...
      { title: 'GEZ / Rundfunkbeitrag', slug: 'gez-rundfunkbeitrag', status: 'internal-page' },
    ],
  },
  {
    id: 'aufenthalt',
    ...
    colorVar: 'aufenthalt',
    items: [
      { title: 'Aufenthaltstitel', slug: 'aufenthaltstitel', status: 'internal-page' },
      { title: 'Visum', slug: 'visum', status: 'internal-page' },
      { title: 'Ausländerbehörde', slug: 'auslaenderbehoerde', status: 'internal-page' },
      { title: 'Arbeitserlaubnis', slug: 'arbeitserlaubnis', status: 'internal-page' },
      { title: 'Niederlassungserlaubnis', slug: 'niederlassungserlaubnis', status: 'internal-page' },
      { title: 'Steuer-ID', slug: 'steuer-id', status: 'internal-page' },
      { title: 'Wichtige Dokumente', slug: 'wichtige-dokumente', status: 'internal-page' },
    ],
  },
  {
    id: 'finanzen',
    ...
    items: [
      ...
      { title: 'Gehalt verstehen', slug: 'gehalt-verstehen', status: 'internal-page' },
      { title: 'Kindergeld', slug: 'kindergeld', status: 'internal-page' },
      { title: 'Steuern & Steuererklärung', slug: 'steuern', status: 'internal-page' },
      { title: 'Sozialleistungen & BAföG', slug: 'sozialleistungen', status: 'internal-page' },
      { title: 'Überweisungen', slug: 'ueberweisungen', status: 'multiple-providers' },
      { title: 'Laufende Kosten', slug: 'laufende-kosten', status: 'internal-page' },
    ],
  },
  {
    id: 'mobilitaet',
    ...
    colorVar: 'mobilitaet',
    items: [
      { title: 'ÖPNV', slug: 'oepnv', status: 'internal-page' },
      ...
      { title: 'Führerschein', slug: 'fuehrerschein', status: 'internal-page' },
      { title: 'Auto', slug: 'auto', status: 'internal-page' },
      { title: 'Fahrrad', slug: 'fahrrad', status: 'internal-page' },
    ],
  },
  {
    id: 'versicherungen',
    ...
    items: [
      { title: 'Krankenversicherung', slug: 'krankenversicherung', status: 'internal-page' },
      { title: 'Privathaftpflicht', slug: 'privathaftpflicht', status: 'internal-page' },
      { title: 'Hausratversicherung', slug: 'hausratversicherung', status: 'internal-page' },
  ...
  },
  {
    ...
    items: [
      { title: 'Deutsch lernen', slug: 'deutsch-lernen', status: 'internal-page' },
      { title: 'Integrationskurs', slug: 'integrationskurs', status: 'internal-page' },
      { title: 'Beruf & Arbeit', slug: 'beruf-arbeit', status: 'internal-page' },
      { title: 'Anerkennung von Abschlüssen', slug: 'abschluesse-integration', status: 'internal-page' },
      { title: 'Schule & Kita', slug: 'schule-kita', status: 'internal-page' },
      { title: 'Kindergarten & Betreuung', slug: 'kindergarten', status: 'internal-page' },
      { title: 'Studium & Ausbildung', slug: 'studium-ausbildung', status: 'internal-page' },
      { title: 'Community', slug: 'community', status: 'internal-page' },
      { title: 'Freizeit & Vereine', slug: 'freizeit', status: 'internal-page' },
    ],
  },
  {
    id: 'alltag',
  ...
  },
  {
    ...
    colorVar: 'verlassen',
    items: [
      { title: 'Vorübergehend ins Ausland', slug: 'voruebergehend-abwesend', status: 'internal-page' },
      { title: 'Dauerhaft auswandern', slug: 'dauerhaft-auswandern', status: 'internal-page' },
      { title: 'Wohnung & Verträge', slug: 'wohnung-vertraege-abreise', status: 'internal-page' },
